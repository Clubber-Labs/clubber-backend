 ...
 * social checa antes de enfileirar; chat filtra no SQL). Erro imediato no
 * ticket com DeviceNotRegistered já invalida o token; os demais erros
 * (entrega) só aparecem no receipt.
 */
