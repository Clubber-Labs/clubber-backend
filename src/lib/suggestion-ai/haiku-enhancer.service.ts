...
2. DESCARTE os lugares que não servem para um rolê social espontâneo: uso individual/serviço (ex.: academia, pet shop) e LOJAS / comércio de varejo, onde se COMPRA um produto e vai embora (ex.: loja de discos, loja de roupas, mercado/supermercado, loja de conveniência) — o que vale é um lugar pra PASSAR UM TEMPO (bar, restaurante, café, cinema, balada, casa de show), não pra comprar. Também descarte os que não casam com o critério acima. Não os devolva.
